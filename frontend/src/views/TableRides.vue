    ...
    <el-dialog v-model="showModal" width="400px" :show-close="true" center>
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <el-button type="primary" @click="openConfirmModal">Participate</el-button>
        </div>
      </div>
    </el-dialog>
...
const tableData = ref([
  { owner: 'Cláudio Souza', date: '13/10/2025', from: 'Ericeira', to: 'Porto', time: '11:00', value: '30€', participating: false },
  { owner: 'Paulo Silva', date: '13/10/2025', from: 'Braga', to: 'Porto', time: '15:00', value: '15€', participating: false },
  { owner: 'Francisco Barbosa', date: '13/10/2025', from: 'Rio Tinto', to: 'Porto', time: '11:30', value: '30€', participating: false },
  { owner: 'Vitor Fonseca', date: '13/10/2025', from: 'Rio de Janeiro', to: 'Porto', time: '13:00', value: '30€', participating: false },
  { owner: 'Paulo Silva', date: '13/10/2025', from: 'Braga', to: 'Lisboa', time: '11:00', value: '30€', participating: false },
  { owner: 'Quim Barreiros', date: '13/10/2025', from: 'Nazaré', to: 'Aveiro', time: '11:00', value: '30€', participating: false },
  { owner: 'Cláudio Souza', date: '13/10/2025', from: 'Ericeira', to: 'Porto', time: '11:00', value: '30€', participating: false },
])
